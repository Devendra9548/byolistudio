    ...
    <div class="container mt-5">
        <div class="form">
            ...
            <form id="addProduct" method="get" action="" enctype="multipart/form-data">
                ...
                <br>
                <label for="r_price">Offer Price</label>
                ...
                <div class="d-flex justify-content-between">
                    <label for="title" class="h6" style="font-size:22px">Red Color</label>
                ...
                <hr>
                <div class="d-flex justify-content-between">
                    <label for="title" class="h6" style="font-size:22px">Blue Color</label>
                    <div class="bothbtn mt-1">
                ...
                <hr>
                <div class="d-flex justify-content-between">
                    <label for="title" class="h6" style="font-size:22px">Black Color</label>
                    <div class="bothbtn mt-1">
                ...
                <p id="messagehere" class="text-success">Product Added Successfully</p>
