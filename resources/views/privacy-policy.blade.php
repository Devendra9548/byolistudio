...
@section('customcss')
<link rel="stylesheet" href="/assets/css/front/policy.css" />
@endsection
@section('body')
<div class="container-fluid breadcrumbs">
    ...
    <div class="row">
        <div class="col-12">
            <p style="margin:0px" class="py-3"><a href="/">Home</a> » <a href="#">Privacy Policy</a></p>
        </div>
    </div>
    </div>
</div>
<div class="container my-5 policy-container">
 <div class="row">
    <div class="col-12">
        ...
        <p>This Privacy Policy describes how Byoli Studio (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from byolistudio.in (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
        ...
        <ul>
          <li><b>Contact details</b> including your name, address, phone number, and email.</li>
          <li><b>Order information</b> including your name, billing address, shipping address, payment confirmation, email address, and phone number.</li>
          <li><b>Account information</b> including your username, password, security questions and other information used for account security purposes.</li>
        ...
        <ul>
          ...
          <li><b>Marketing and Advertising.</b> We may use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you advertisements for products or services. This may include using your personal information to better tailor the Services and advertising on our Site and other websites.</li>
          ...
          <li><b>Communicating with You and Service Improvement.</b> We use your personal information to provide you with customer support and improve our Services. This is in our legitimate interests in order to be responsive to you, to provide effective services to you, and to maintain our business relationship with you</li>
        </ul>
        <h2>Cookies</h2>
        <p>Like many websites, we use Cookies on our Site. Cookies help us improve and optimize our Site and Services by remembering your actions and preferences, running analytics to better understand user interaction, and enhancing overall functionality. We may also allow third parties and service providers to use Cookies on our Site to offer tailored services, products, and advertising.</p>
        <p>Most browsers automatically accept Cookies by default, but you can set your browser to remove or reject Cookies through your browser settings. Please note that removing or blocking Cookies may negatively impact your user experience and could cause certain features or functionality to stop working properly. Blocking Cookies may also not completely prevent information sharing with third parties, such as our advertising partners.</p>
        ...
        <p>We disclose the following categories of personal information and sensitive personal information about users for the purposes set out above in "How we Collect and Use your Personal Information" and "How we Disclose Personal Information":</p>
        <table>
  <thead>
    <tr>
      <th>Category</th>
...
<p class="mt-3">We do not use or disclose sensitive personal information without your consent or for the purposes of inferring characteristics about you.</p>
...
<h2>Contact</h2>
<p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call on this number Tel: <a href="tel:+919756605898"></a> +91-9756605898  or email us at <a href="mailto:byolidm@gmail.com">byolidm@gmail.com</a> or Reach us at 22/94, Haldwani, Nainital, Uttarakhand, 263139.</p>
    </div>
 </div>
</div>
@endsection