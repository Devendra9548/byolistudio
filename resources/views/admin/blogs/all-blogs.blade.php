                ...
                <table class="table table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> {{ $blog->id }}</td>
                            <td> {{ $blog->title }}</td>
                            <td> <img src="/recent-blogs-thumb/{{ $blog->file }}" alt="{{ $blog->file }}" style="width:100px; height: 50px;object-fit: cover;border: 1px solid #0009;"></td>
                            <td> {{ $blog->bcname }}</td>
                            <td class="">
                                <a href="#" class="btn btn-secondary text-white seotag m-1" value="{{ $blog->id }}"
                                    ...
                                    SEO</a>
                                <a id="views" target="_blank" href="/blog/{{ $blog->slug }}" class="btn btn-success text-white reads views1 m-1"
                                    ><i
                                        class="fa-solid fa-eye"></i> View</a>
                                <a href="#" class="btn btn-warning text-white edit m-1" value="{{ $blog->id }}"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <a href="#" class="btn btn-danger text-white delete m-1" value="{{ $blog->id }}"><i
