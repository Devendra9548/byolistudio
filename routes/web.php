...
Route::post('success-payment', [RazorpayController::class, 'success'])->name('successpay');
...
Route::get('/refund-policy', [frontendController::class, 'cancellation'])->name('front.cancellation');
...
Route::get('/shipping-policy', [frontendController::class, 'disclaimer'])->name('front.disclaimer');
